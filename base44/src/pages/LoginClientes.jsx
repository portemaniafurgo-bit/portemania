  ...
  return (
    <AuthLayout
      ...
      footer={
        <>
          ¿No tienes cuenta?{" "}
          <Link to="/bienvenida" className="text-primary font-medium hover:underline">
            Registrarse
          </Link>
        </>
      }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-xs text-primary hover:underline">¿Olvidaste la contraseña?</Link>
          </div>
          <div className="relative">
